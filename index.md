...
<div class="site-wrapper">
  ...
  <section class="site-section" id="skills">
    ...
    <ul class="skill-list">
      ...
      <li class="skill-entry">
        <h3>Design</h3>
        <p>Low-power design &amp; clock gating, UPF power intent, STA (setup/hold), CDC &amp; RDC synchronizers, RTL linting, FSM design, logic synthesis, bus protocols (AXI, APB).</p>
      </li>
      <li class="skill-entry">
        <h3>Computer Architecture</h3>
        <p>RISC-V, 5-stage in-order pipelines, branch prediction, cache &amp; memory-hierarchy modeling.</p>
      </li>
      <li class="skill-entry">
        <h3>Verification &amp; Debug</h3>
        <p>UVM (agents, sequences, scoreboards), constrained-random verification, functional &amp; code coverage, SVA, directed/self-checking testbenches, waveform debug.</p>
      </li>
      <li class="skill-entry">
        <h3>Tools</h3>
        <p>Synopsys DC, VCS, ModelSim, QuestaSim, Intel Quartus Prime, AMD Vivado, Intel Pin, Git, Linux.</p>
      </li>
    </ul>
  </section>
  ...
  <section class="site-section" id="certifications">
    ...
    <ul class="info-list">
      <li class="info-entry">
        ...
        <p>Learned digital design fundamentals &amp; PPA trade-offs on paper.</p>
      </li>
      <li class="info-entry">
        <h3>SoC Design Using Xilinx FPGAs</h3>
        <p>OneRupeeST · Oct 2022</p>
        <p>Learned to write Verilog, worked through 200+ design examples, &amp; completed the DMA-with-AXI project above.</p>
      </li>
      <li class="info-entry">
